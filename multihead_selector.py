...
from models.module import HeadSelectorModel
...
@hydra.main(config_path="configs", config_name="hs_config", version_base=None)
def main(cfg):
    ...
    model = HeadSelectorModel.load_from_checkpoint(checkpoint_path, cfg=cfg.model)
    model.eval()
