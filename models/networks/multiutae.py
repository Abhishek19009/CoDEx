...
def save_features(module, input, output):
    """ Hook function to save the output features """
...
class MultiUTAE(nn.Module):
    def __init__(
        ...
        # Register the hook to capture features before out_conv
        self.up_blocks[-1].register_forward_hook(save_features)
    ...
    def forward(self, batch):
        ...
        out = self.out_conv(out.view(batch_size * seq_len, -1, h, w)).view(
